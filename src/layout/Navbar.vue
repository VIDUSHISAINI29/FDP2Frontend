...
<template>
   <div class="">
      <div class="navbar tw-rounded-[100px] tw-items-center tw-m-1 tw-w-[93vw] tw-text-white tw-text-lg tw-font-semibold tw-flex tw-p-2 tw-px-8 tw-justify-between tw-bg-[#156355]">
